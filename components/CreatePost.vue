  ...
  <div class="fixed z-50 bottom-0 h-full w-full overflow-hidden">
    <div class="bg-black h-full w-full text-white overflow-auto">
      ...
      >
        ...
        <div class="text-[16px] font-semibold">New Post</div>
      </div>

      <div
        id="Post"
        class="z-40 bottom-0 max-h-[100vh-500px] w-full px-3 max-w-[500px] mx-auto"
      >
        <div class="py-2 w-full">
          ...
          <div class="relative flex items-center w-full">
            ...
            <div class="rounded-lg w-[calc(100%-50px)] text w-full font-light">
